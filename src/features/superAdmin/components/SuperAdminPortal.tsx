              ...
              <div className={`space-y-6 transition-all duration-200 ${ttsEnabled ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2 mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                    <h4 className="text-sm font-bold text-slate-805 dark:text-white flex items-center gap-2">
                      <Volume2 className="w-5 h-5 text-brand-500" />
                      Dynamic English Playback Settings
                    </h4>
                    <p className="text-xs text-slate-550 dark:text-slate-400 mt-1">
                      Configure parameters for playing queue announcements in English when selected at the kiosk.
                    </p>
                  </div>
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-600 dark:text-slate-400 mb-2 flex items-center gap-1">
                      <span>English Voice Name / Model</span>
                      <span className="group relative">
                        <HelpCircle className="w-3.5 h-3.5 text-slate-400 cursor-pointer" />
                        <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-2 bg-slate-950 text-white text-[10px] rounded shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity z-10">
                          Browser: Keep blank for default. Cloud Google: e.g. en-US-Standard-A. OpenAI: alloy, echo, fable, onyx, nova, shimmer.
                        </span>
                      </span>
                    </label>
                    <input
                  ...
                  {/* Volume Slider */}
                  <div>
                    <label className="block text-xs font-semibold text-slate-600 dark:text-slate-455 mb-2 flex justify-between">
                      <span>Volume</span>
                  ...
                  <div className="md:col-span-2 mt-6 pt-6 border-t border-slate-100 dark:border-slate-800">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-800/40 p-3 rounded-xl border border-slate-150 dark:border-slate-800">
                        ...
                        <select
                          ...
                          className="px-3 py-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-xs font-bold text-slate-800 dark:text-white outline-none"
                        >
                          ...
                          <div key={id} className="p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col justify-between shadow-sm">
                            <div>
                              <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="text-[10px] bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded font-mono text-slate-500">{id}</span>
                              </div>
                              <div className="text-xs text-slate-500 space-y-1.5">
                                <div>
                                  <strong className="text-slate-700 dark:text-slate-400">Thai (th):</strong> {s.languages?.th?.ttsTemplate || 'None'}
                                </div>
                                <div>
                                  <strong className="text-slate-700 dark:text-slate-400">English (en):</strong> {s.languages?.en?.ttsTemplate || 'None'}
                                </div>
                              </div>
                            </div>
                            <div className="flex justify-end gap-2 mt-4 pt-3 border-t border-slate-50 dark:border-slate-850">
                              <button
                                type="button"
                                onClick={() => handleEditStyle(id, s)}
                                className="px-2.5 py-1 bg-slate-50 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 text-xs font-bold rounded-lg transition-all"
                              >
                                Edit
                              </button>
                              <button
                                ...
                                className="px-2.5 py-1 bg-rose-50 hover:bg-rose-100 text-rose-600 dark:bg-rose-950/20 dark:hover:bg-rose-900/20 text-xs font-bold rounded-lg transition-all"
                              >
                                Delete
                              </button>
                            </div>
                      ...
                      {/* Add/Edit Style Form Box */}
                      {editingStyleId !== null ? (
                        <div className="p-4 bg-slate-50 dark:bg-slate-800/20 border border-slate-200 dark:border-slate-800 rounded-2xl space-y-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {editingStyleId === 'new' && (
                              <div>
                                <label className="block text-xs font-semibold mb-1 text-slate-600 dark:text-slate-350">Style Key (e.g. style1)</label>
                                <input
                                  type="text"
                                  placeholder="style1"
                                  id="temp-style-key"
                            ...
                            <div>
                              <label className="block text-xs font-semibold mb-1 text-slate-600 dark:text-slate-350">Style Name</label>
                              <input
                                type="text"
                                value={styleName}
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                            ...
                            <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200/60 dark:border-slate-800 space-y-3">
                              ...
                              <div>
                                <label className="block text-[10px] font-bold mb-1 text-slate-500">Language Code</label>
                                <input
                                  type="text"
                                  value={styleThLang}
                              ...
                              <div>
                                <label className="block text-[10px] font-bold mb-1 text-slate-500">Voice Name</label>
                                <input
                                  type="text"
                                  value={styleThVoice}
                              ...
                              <div>
                                <label className="block text-[10px] font-bold mb-1 text-slate-500">Template</label>
                                <input
                                  type="text"
                          ...
                          <div className="flex justify-end gap-2 pt-2">
                            <button
                              ...
                              className="px-4 py-1.5 bg-slate-200 dark:bg-slate-800 dark:text-slate-350 rounded-lg text-xs font-bold"
                            >
                              Cancel
                            </button>
                            <button
                              ...
                              className="px-4 py-1.5 bg-brand-600 hover:bg-brand-500 text-white rounded-lg text-xs font-bold"
                            >
                              Apply Style Changes
                            </button>
                          </div>
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-brand-50 hover:bg-brand-100 text-brand-700 dark:bg-brand-950/20 dark:hover:bg-brand-900/20 text-xs font-bold rounded-lg transition-all"
                        >
