        ...
        <div className="space-y-6">
          ...
          <div className="flex border-b border-slate-200 dark:border-slate-800">
            <button
              ...
              className={`px-6 py-3 text-sm font-bold border-b-2 transition-all cursor-pointer ${activeTab === 'kiosk'
            ...
            <button
              ...
              className={`px-6 py-3 text-sm font-bold border-b-2 transition-all cursor-pointer flex items-center gap-1.5 ${activeTab === 'ticket'
                  ? 'border-brand-500 text-brand-600 dark:text-brand-400'
                  : 'border-transparent text-slate-400 hover:text-slate-900 dark:hover:text-white'
                }`}
            >
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                      {themeOptions.map((opt) => (
                        <button
                          ...
                          className={`flex flex-col items-center gap-2 p-3 rounded-2xl border-2 transition-all cursor-pointer ${themeColor === opt.value
                        ...
                        {services.map((service) => {
                          ...
                          return (
                            <div
                              ...
                              className={`flex items-center space-x-3 p-3.5 rounded-xl border transition-all cursor-pointer ${isChecked
                        ...
                        {allowedServiceIds.map((serviceId, index) => {
                          ...
                          return (
                            <div
                              ...
                              className={`flex items-center justify-between p-3.5 bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-800 rounded-2xl transition-all cursor-move select-none ${draggedIndex === index
                  ...
                  <div className="p-4 bg-slate-50 dark:bg-slate-800/20 border border-slate-100 dark:border-slate-800/80 rounded-2xl space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className={`flex items-center justify-between p-3.5 rounded-xl border transition-all cursor-pointer ${pageSize === '80mm'
                      ...
                      <button
                        ...
                        className={`flex items-center justify-between p-3.5 rounded-xl border transition-all cursor-pointer ${pageSize === '58mm'
                            ? 'border-brand-500 bg-brand-50/20 dark:bg-brand-950/10 text-brand-600 dark:text-brand-400 font-bold'
                      ...
                      {ticketLayout.map((el, index) => {
                        ...
                        return (
                          <div
                            ...
                            className={`flex flex-col p-3 bg-slate-50 dark:bg-slate-800/30 border border-slate-200 dark:border-slate-800 rounded-2xl transition-all cursor-move select-none ${draggedTicketIndex === index
                                ? 'opacity-40 border-dashed border-brand-500 bg-brand-50/10'
                                : 'hover:border-slate-350 dark:hover:border-slate-750'
                              }`}
                          >
                            ...
                            <div className="flex items-center justify-between pb-2 mb-2 border-b border-slate-150/50 dark:border-slate-800/50">
                              ...
                              <div className="flex items-center gap-1.5">
                                ...
                                <button
                                  ...
                                  className={`p-1.5 rounded-lg border transition-all cursor-pointer ${el.visible
                                ...
                                <div className="sm:col-span-6 flex items-center justify-end gap-2">
                                  ...
                                  {el.type !== 'logo' && (
                                    <button
                                      ...
                                      className={`p-1.5 rounded-lg border transition-all cursor-pointer ${el.bold
                                    ...
                                    {(['left', 'center', 'right'] as const).map((alignOpt) => {
                                      ...
                                      return (
                                        <button
                                          ...
                                          className={`p-1.5 transition-all cursor-pointer border-r last:border-r-0 border-slate-200 dark:border-slate-850 ${isSelected
                              ...
                              return (
                                <div key={el.id} className={`flex ${el.align === 'left' ? 'justify-start' : el.align === 'right' ? 'justify-end' : 'justify-center'} my-1`}>
                                  {!isFreePlan && tenant?.logo ? (
                                    ...
                                    <img src="/logo_mono_2.png" alt="Logo" className="w-8 h-8 object-contain" />
                                  )}
                                </div>
                              );
                            case 'branchName':
