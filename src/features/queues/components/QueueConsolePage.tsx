    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white dark:bg-slate-900 p-6 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-sm">
        <div>
          <h2 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
            <ConciergeBell className="w-5.5 h-5.5 text-brand-600 dark:text-brand-400" />
        ...
        <div className="flex flex-wrap items-center gap-4 w-full sm:w-auto justify-end">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-5 py-2 bg-brand-600 hover:bg-brand-500 disabled:bg-slate-100 dark:disabled:bg-slate-800 disabled:text-slate-400 dark:disabled:text-slate-600 disabled:shadow-none disabled:cursor-not-allowed disabled:transform-none text-white rounded-xl text-xs font-bold shadow-md shadow-brand-600/15 hover:scale-[1.01] active:scale-[0.99] transition-all cursor-pointer w-full sm:w-auto justify-center"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl flex items-center justify-between shadow-sm">
          ...
          <div className="p-3 bg-brand-50 dark:bg-brand-950/20 rounded-xl text-brand-600 dark:text-brand-400">
                    ...
                    <div className="mt-5 pt-4 border-t border-slate-100 dark:border-slate-800/80 flex flex-wrap items-center justify-end gap-2.5">
                      ...
                      {ticket.status === 'WAITING' && (
                        <button
                          ...
                          className="flex-1 py-1.5 px-3 bg-brand-50 dark:bg-brand-950/20 text-brand-600 dark:text-brand-400 hover:bg-brand-100 dark:hover:bg-brand-900/30 font-bold text-xs rounded-xl flex items-center justify-center gap-1 cursor-pointer transition-colors"
                        >
                      ...
                      {ticket.status === 'CALLED' && (
                        <>
                          ...
                          <button
                            ...
                            className="p-2 text-slate-400 hover:text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/20 rounded-xl transition-colors cursor-pointer border border-transparent hover:border-brand-200"
                          ...
                          <button
                            ...
                            className="flex-1 py-1.5 px-3 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded-xl flex items-center justify-center gap-1 cursor-pointer transition-transform"
                          >
                            <Play className="w-3.5 h-3.5 fill-current" />
                      ...
                      {ticket.status === 'SERVING' && (
                        <>
                          ...
                          <button
                            ...
                            className="flex-1 py-1.5 px-3 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded-xl flex items-center justify-center gap-1 cursor-pointer transition-transform shadow-md shadow-emerald-500/10"
                          >
