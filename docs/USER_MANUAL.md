...
- **Event Webhooks:** ระบบส่งข้อมูล Webhook ไปยัง URL ปลายทางโดยมีลายเซ็นดิจิทัล SHA-256 HMAC เพื่อยืนยันความปลอดภัยและความถูกต้องของข้อมูลเมื่อสถานะคิวเปลี่ยนแปลง (เช่น คิวถูกสร้าง, ถูกเรียก, บริการเสร็จสิ้น)
- **Webhook Delivery Logs:** บันทึกประวัติการส่ง Webhook รวมถึงการตอบกลับของ HTTP status, ข้อมูล JSON Payload และข้อความข้อผิดพลาดแบบละเอียด
