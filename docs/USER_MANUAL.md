...
### ขั้นตอนที่ 6: การตั้งค่าบัญชีธุรกิจและการยกเลิกแพ็คเกจ (Tenant Settings & Subscription)
...
3. **แท็บ ข้อมูลแพ็คเกจ (Subscription & Usage):**
   * ตรวจสอบข้อมูลแพ็คเกจปัจจุบันและสถานะการต่ออายุ (เช่น Standard Trial SaaS Plan: Active)
   * แสดงขีดจำกัดและการใช้งานทรัพยากรจริงในรูปแบบแถบความคืบหน้า (Progress Bar) เช่น จำนวนสาขาที่เปิดให้บริการ (สูงสุด 5 สาขา) และจำนวนพนักงานที่เพิ่มเข้าในระบบ (สูงสุด 10 คน)
4. **แท็บ โซนอันตราย (Danger Zone):**
